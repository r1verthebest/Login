...
public class BungeeMain extends Plugin {
    ...
    public void onEnable() {
        ...
        try {
            ...
            getLogger().info("§aLogin v" + getDescription().getVersion() + " ativado com sucesso.");
        } catch (Exception e) {
    ...
    private boolean setupDatabase() {
        ...
        try {
            ...
            if (this.mysql.startConnection() == null) {
                return false;
            }
            ...
            getLogger().log(Level.SEVERE, "Erro ao configurar MySQL:", e);
            return false;
        }
    }

    private void registerCommands() {
        getProxy().getPluginManager().registerCommand(this, new ChangePassCommand());
    }
    ...
    public void onDisable() {
        ...
        getLogger().info("Login finalizado com segurança.");
        instance = null;
    }
